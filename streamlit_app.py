...
# --- Navigation / Tabs for Unified Workflow ---
tab1, tab2 = st.tabs(["📊 Master Trade Setups & Report", "⚙️ Strategy Backtest Engine"])
...
with tab1:
    ...
    # Mock/Sample Top 15 Table (Ready to link to your screening module)
    ...
    st.info("💡 Tip: Head over to the **Strategy Backtest Engine** tab to run simulations on any of these market leaders.")
